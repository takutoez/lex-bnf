...
/**
 * Test if the character is a kind of punctuators.
 * @param {string} c a character.
 * @return {boolean} the test result.
 */
...
LexAnalyzer.prototype.parseIdentifier = function() {
    if(!(LexAnalyzer.isWhite(this._c) || LexAnalyzer.isPunct(this._c))) {
        this._token.pushChar(this._c);
    } else {
        this.finishToken();
        this.ungetChar();
